...
import darkPicture from '../../../assets/images/letmain.jpg';
        ...
        <PresentContainer >
          ...
          <div className="Container">
            <div className="TextContainer">
              <h1>Sou <span>Emily Pereira</span></h1>
      ...
      <AboutMeSection id="aboutMe" >
        <AboutMeContainer>
          <div className='TextContainer'>
            ...
            <SectionText>
              Meu nome é Emily Pereira, tenho 18 anos e estudo Produção de Moda e Stylist na EEEP Leonel de Moura Brizola.
            </SectionText>
